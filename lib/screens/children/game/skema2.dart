...
class JigsawPuzzleScreenSkema2 extends StatefulWidget {
  final int idTema;
  const JigsawPuzzleScreenSkema2({Key? key, required this.idTema})
      : super(key: key);
  @override
...
class _JigsawPuzzleScreenState extends State<JigsawPuzzleScreenSkema2> {
  ...
  Widget build(BuildContext context) {
    ...
    String kata = _currentIsiGambarList[_currentIndex].label;
          ...
          : Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    kata ?? '', // Display isiGambar.label if not null
                    style: TextStyle(
