...
class JigsawPuzzleScreenSkema2 extends StatefulWidget {

    final int idTema;
  const JigsawPuzzleScreenSkema2({Key? key, required this.idTema}) : super(key: key);
  @override
  _JigsawPuzzleScreenState createState() => _JigsawPuzzleScreenState();
}

class _JigsawPuzzleScreenState extends State<JigsawPuzzleScreenSkema2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.volume_up, size: 36.0, color: Colors.white),
